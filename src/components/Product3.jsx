...
const Product3 = () => {
    ...
    const cardItemb = (item) => {
        return (
            <div class="card my-5 py-4" key={item.id} style={{width: "12rem",backgroundColor:'#dfffe0'}}>
      ...
      <ReactStars {...firstExample} />
                        ...
                        <NavLink to={`/products3/${item.id}`} class="btn btn-outline-secondary" style={{color:'#fff',borderColor:'#202235',backgroundColor:'#202235'}}>Buy Now</NavLink>
                    </div>
                    ...
                    <div class="card-body text-center">
                        ...
                        {/* <NavLink to={`/products/${item.id}`} class="btn btn-outline-primary">Buy Now</NavLink><br/><br/> */}
                        <NavLink to={`/products3/${item.id}`} class="btn btn-outline-warning"  style={{borderColor:'#202235',color:'#202235'}}>View More</NavLink>
                    </div>
